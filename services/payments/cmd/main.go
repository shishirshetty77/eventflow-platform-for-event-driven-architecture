// Package main is the entry point for the payments service.
package main
...
import (
	...
	"github.com/microservices-platform/services/payments/internal/config"
	"github.com/microservices-platform/services/payments/internal/core"
)
